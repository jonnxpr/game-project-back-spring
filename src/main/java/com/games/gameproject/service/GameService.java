...
public class GameService {
        ...
        public List<Game> findAll() {
                try {
                        ...
                        throw new CustomException("Error fetching all games", e);
                }
        }
        ...
        public Game findById(Long id) {
                try {
                        ...
                        // Handle exception, log it, rethrow it, or return a default value
                        throw new CustomException("Error fetching game by ID", e);
                }
        }
        ...
        public Game save(Game game) {
                try {
                        ...
                        // Handle exception, log it, rethrow it, or return a default value
                        throw new CustomException("Error saving game", e);
                }
        }
        ...
        public void deleteAll() {
                try {
                        ...
                        // Handle exception, log it, rethrow it, or return a default value
                        throw new CustomException("Error deleting all games", e);
                }
        }
        ...
        public List<Game> findByNameContainingIgnoreCase(String name) {
                try {
                        ...
                        // Handle exception, log it, rethrow it, or return a default value
                        throw new CustomException("Error finding games by name", e);
                }
        }
        ...
        public List<Game> findByGenreContainingIgnoreCase(String genre) {
                try {
                        ...
                        // Handle exception, log it, rethrow it, or return a default value
                        throw new CustomException("Error finding games by genre", e);
                }
        }
        ...
        public List<Game> findByPlatformContainingIgnoreCase(String platform) {
                try {
                        ...
                        // Handle exception, log it, rethrow it, or return a default value
                        throw new CustomException("Error finding games by platform", e);
                }
        }
        ...
        public List<Game> findByCompanyContainingIgnoreCase(String company) {
                try {
                        ...
                        // Handle exception, log it, rethrow it, or return a default value
                        throw new CustomException("Error finding games by company", e);
                }
        }
        ...
        public List<Game> findByReleaseDate(Timestamp releaseDate) {
                try {
                        ...
                        // Handle exception, log it, rethrow it, or return a default value
                        throw new CustomException("Error finding games by release date", e);
                }
        }
        ...
        public List<Game> findByDescriptionContainingIgnoreCase(String description) {
                try {
                        ...
                        // Handle exception, log it, rethrow it, or return a default value
                        throw new CustomException("Error finding games by description", e);
                }
        }
        ...
        public void populateDatabase() {
                ...
                try {
                        ...
                        // Handle exception, log it, rethrow it, or return a default value
                        throw new CustomException("Error populating database", e);
                }
        }
}
